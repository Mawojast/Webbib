...
* @see app/Http/Controllers/Explorer/FolderController.php:46
...
* @see app/Http/Controllers/Explorer/FolderController.php:55
* @route '/explorer/folder/{folder}'
*/
...
* @see app/Http/Controllers/Explorer/FolderController.php:79
* @route '/explorer/folder/{folder}'
*/
...
* @see app/Http/Controllers/Explorer/FolderController.php:69
* @route '/explorer/folder/{folder}'
*/
...
const FolderController = { edit, index, store, destroy, update }
